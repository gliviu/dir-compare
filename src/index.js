...
const defaultFileCompare = require('./fileCompareHandler/default/defaultFileCompare').default
const lineBasedFileCompare = require('./fileCompareHandler/lines/lineBasedFileCompare').default
